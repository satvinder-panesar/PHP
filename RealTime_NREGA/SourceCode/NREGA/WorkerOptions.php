...
echo "<table>
<tr>
<td><a href=HomePage.php ><center><<<   Sign Out</center></a></td>
</tr>
</table>";
$jobid=$_REQUEST['jobid'];
echo "<center><br><h3>
<a href=ChangeWorkerPassword.php?jobid=$jobid>Change Password</a><br><br>
<a href=JobCard.php?jobid=$jobid>View Job Card</a><br><br>";
?>
<div class="bottom">
<ul>
   <li><a href="HomePage.php">Home</a></li>
